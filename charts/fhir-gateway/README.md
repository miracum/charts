...
$ helm repo update
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=4.0.0
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=4.0.0 --set replicaCount=1
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=4.0.0 --values values.yaml
```
