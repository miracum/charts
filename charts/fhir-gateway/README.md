...
$ helm repo update
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.6
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.6 --set replicaCount=1
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.6 --values values.yaml
```
