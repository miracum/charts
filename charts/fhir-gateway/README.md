...
$ helm repo update
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.7
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.7 --set replicaCount=1
```
...
```console
$ helm install fhir-gateway miracum/fhir-gateway -n fhir-gateway --version=3.5.7 --values values.yaml
```
